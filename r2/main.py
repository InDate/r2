...
def main(args=None, input=None, output=None):
    ...
    env_prefix = "r2_"
    parser = argparse.ArgumentParser(description="r2 - chat with GPT about your code")
    parser.add_argument(
        "files",
        metavar="FILE",
        nargs="*",
    ...
    parser.add_argument(
        ...
        default=os.environ.get(f"{env_prefix}INPUT_HISTORY_FILE", ".r2.input.history"),
        help=(
            "Specify the chat input history file (default: .r2.input.history,"
    ...
    parser.add_argument(
        ...
        default=os.environ.get(f"{env_prefix}CHAT_HISTORY_FILE", ".r2.chat.history.md"),
        help=(
            "Specify the chat history file (default: .r2.chat.history.md,"
